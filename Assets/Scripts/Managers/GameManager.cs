...
public class GameManager : NetworkBehaviour
{
    ...
    // This dictionary connects NGO clientIds to the player names generated by Relay
    ...
    {
        //Get our player names as they load in
        string playerName = LobbyManager.Instance.CurrentSession.CurrentPlayer.GetPlayerName();
    ...
    // Add a clientId player name key value pair
    [Rpc(SendTo.Server)]
    private void RegisterPlayerNameServerRpc(string playerName, RpcParams rpcParams = default)
    {
        ulong clientId = rpcParams.Receive.SenderClientId;
        _playerNames[clientId] = playerName;
        Debug.Log($"Registered {clientId} as {playerName}");
    }
